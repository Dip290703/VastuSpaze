...
const Navbar = () => {
  ...
  return (
    <nav className='border-b-2'>
      <div className='max-w-2xl mx-auto flex justify-between items-center py-8'>
      <div className='pl-2'>
        <a href="#">
          <img src={logo} alt="vastusapze" width={150 } height={15} />
        </a>
      </div>
      <div className='md:hidden'>
        <button onClick={toggleMenu} className='text-2xl pr-2' aria-label={isOpen? "close menu ":"open menu"}>
